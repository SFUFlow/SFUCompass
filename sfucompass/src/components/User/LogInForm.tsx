...
export default function LogInForm() {
    ...
    const handleInput = (e: React.FormEvent<LogInForm>) => {
        e.preventDefault();
        ...
        <div>
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen w-full">
                ...
                <div className="w-full ">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleInput} noValidate>
                    ...
                    <div>
                        ...
                        <button type="button" className="w-full text-black outline outline-1 bg-white rounded-md p-2">Log in with something else</button>
